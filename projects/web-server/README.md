...
Consulta el archivo [`API_TESTING.md`](./docs/API_TESTING.md) para ver una lista completa de comandos `curl` listos para copiar y pegar, que cubren todos los endpoints del sistema.
